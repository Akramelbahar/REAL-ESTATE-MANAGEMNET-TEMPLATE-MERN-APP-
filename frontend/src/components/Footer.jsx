  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul 
        ...
        <a href="/dashboard"><li className={(btnLogout == "none" ) || isDashboard ? "hidden": "btn btn-accent text-center m-1 block"  }  >Dashboard</li> </a>
        <a href="/login"><li className={btnLogin == "none" ? "hidden" : "btn btn-accent block text-center m-1"} >Se Connecter</li></a>
        <a href="/chat"><li className={btnLogout == "none" || isChat  ? "hidden" : "btn btn-accent block text-center m-1"} >💬</li></a>
        <a href="signup"><li className={btnSignup=="none" ? "hidden": "btn   btn-accent block text-center m-1"  }  >S'Inscrire</li></a>
        <a className="btn  md:hidden btn-accent block text-center m-1" href="insertAd" >Publier Une Annonce</a>
        
        <a href="/logout"><li className={btnLogout == "none"? "hidden": "btn   btn-accent block text-center m-1 m-1"  }  >Se Deconnecter</li></a>
