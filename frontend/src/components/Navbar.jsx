  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul
        ...
        <a  className="btn  md:hidden btn-accent ml-1 " href="/dashboard"><li className={(btnLogout == "none" ) || isDashboard ? "hidden": "btn ring my-2  btn-accent ml-1 mr-1"  }  >Dashboard</li> </a>
        <a  className="btn  md:hidden btn-accent ml-1 " href="/login"><li className={btnLogin == "none" ? "hidden" : "btn ring my-2   btn-accent ml-1 mr-1"}>Se Connecter</li></a>
        <a  className="btn  md:hidden btn-accent ml-1 " href="/chat"><li className={btnLogout == "none" || isChat  ? "hidden" : "btn ring my-2  btn-accent ml-1 mr-1"}>💬</li></a>
        <a  className="btn  md:hidden btn-accent ml-1 " href="signup"><li className={btnSignup=="none" ? "hidden": "btn ring my-2  btn-accent ml-1 mr-1"  }  >S'Inscrire</li></a>
        <a className="btn  md:hidden btn-accent ml-1 " href="insertAd">Publier Une Annonce</a>
